...
<html>
<title>RAWR Account Settings</title>
<body>
...
<td><input type="password" name="repass" maxlength="30" value="
<? echo $form->value("repass"); ?>"></td>
<td><? echo $form->error("repass"); ?></td>
</tr>
<tr>
<td>Email:</td>
...
<td><input type="checkbox" name="notifications" value="notifications"
<?
connect();
$result = mysql_query( "SELECT SpamMail FROM Student WHERE SysID=" . $session->id );
